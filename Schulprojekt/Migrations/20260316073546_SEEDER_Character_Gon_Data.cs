...
{
    /// <inheritdoc />
    public partial class SEEDER_Character_Gon_Data : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
               table: "Character",
               columns: new[] { "CharacterID", "Name", "GettingByCompletingTheme", "Backstory", "NormalEndText", "ProfiEndText", "TopEndText" },
               values: new object[,]
               {
                    { 1, 
                       "Gon Disk", 
